              ...
              Container(
                ...
                child: Column(
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      height: 30,
                                      width: 90,
                                      padding: EdgeInsets.only(top: 4, bottom: 4, left: 17,right:4 ),
                                      decoration: BoxDecoration(
                                        color: Colors.black,
                  ...
                  Column(
                    children: [
                      Padding(
                        padding: EdgeInsets.only(top: 300, bottom: 40, left: 30, right: 30 ),
                        child: SizedBox(
                          height: 90,
                          width: double.infinity,
                                ...
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      color: const Color.fromARGB(255, 247, 215, 244),
                                    ),
